public class CompInfo {
    //2 OF
    String[] CIS_CAROLINA_CORE_ARP = {"CSCE145", "MATH122", "MATH141"};
    //2 OF
    String[] CIS_CAROLINA_CORE_SCI = {"BIOL101", "BIOL101L", "BIOL102", "BIOL102L", "BIOL120", "BIOL120L", 
    ...
    //3 OF
    String[] CIS_GEN_ED_MATH = {"Math174", "MATH374", "STAT509", "STAT515", "STAT516"};
   //THREE OF
   String[] CIS_GEN_ED_LIBARTS = {" AERO401", "AERO402", "ANTH101", "ANTH499", "ARMY401", "ARMY402", "ARTE101", "ARTE260", 
    ...
    //ALL OF
    String[] CIS_LOWER_DIV_COMPUTING = {"CSCE146", "CSCE190", "CSCE201", "CSCE210", "CSCE215", "CSCE240"};
    //ALL OF
    String[] CIS_REQUIRED = {"CSCE205", "CSCE311", "CSCE350", "CSCE416", "CSCE490", "CSCE492", "CSCE520", "CSCE522"};
    //ONE OF
    String[] CIS_ELECTIVE = {"CSCE317", "CSCE500", "CSCE699"};
    //ALL OF
    String[] CIS_BIM_REQUIRED = {"ECON224", "ACCT222", "MGMT371", "MDSC390", "MGSC490", "MGSC590"};
    //TWO OF
    String[] CIS_BIM_ELECTIVE = {"ACCT324", "ECON311", "ECON379", "FINA333", "IBUS301", "MGMT472", "MKTG350", "MKTG351", "MGSC392", "MGSC395", "MGSC594"};
